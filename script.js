          ...
          .then(function (response) {
            if (response.ok) {
              ...
              fields.forEach(function (f) {
                f.classList.remove('input-error', 'input-valid');
              });
    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "NextGen Store משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: 'ad8c7448-20e8-475c-a904-57cac19584dd',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || 'ad8c7448-20e8-475c-a904-57cac19584dd';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = 'ad8c7448-20e8-475c-a904-57cac19584dd';
